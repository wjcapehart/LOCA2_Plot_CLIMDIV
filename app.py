...
app_ui = ui.page_sidebar(
    ...
    ui.p("This display shows a a series of climate simulations from the CMIP6 Climate Model Ensembles and are a collection of the best simulations from each center's model participating in CMIP6.",ui.br(),ui.br()),
    ...
    ui.p("The user may select a variable from the pulldown menues and also a future 30-year period to view the monthly trends and compare them to a fixed historical period (1981-2010).",ui.br(),ui.br()),
